...
#if !defined(STLSOFT_INCL_STLSOFT_HPP_INTEGER_TO_STRING)
# error This file cannot be directly included, and should only be included within stlsoft/integer_to_string.hpp
