...
#if !defined(STLSOFT_INCL_STLSOFT_HPP_NEW_ALLOCATOR)
# error This file cannot be directly included, and should only be included within stlsoft/new_allocator.hpp
