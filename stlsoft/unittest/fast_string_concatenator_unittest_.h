...
#if !defined(STLSOFT_INCL_STLSOFT_HPP_FAST_STRING_CONCATENATOR)
# error This file cannot be directly included, and should only be included within stlsoft/fast_string_concatenator.hpp
