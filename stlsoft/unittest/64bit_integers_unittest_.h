...
#if !defined(STLSOFT_INCL_STLSOFT_HPP_64BIT_INTEGERS)
# error This file cannot be directly included, and should only be included within stlsoft/64bit_integers.hpp
