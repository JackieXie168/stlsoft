...
#if !defined(STLSOFT_INCL_STLSOFT_HPP_TYPE_TRAITS)
# error This file cannot be directly included, and should only be included within stlsoft/type_traits.hpp
...
#  endif /* __STLSOFT_CF_STATIC_ARRAY_SIZE_DETERMINATION_SUPPORT */
        ...
        ss_bool_t test_stlsoft_type_traits(unittest_reporter *r)
        {
            ...
            unittest_initialiser    init(r, "STLSoft", "type_traits", __FILE__);
...
# endif /* __STLSOFT_CF_TEMPLATE_PARTIAL_SPECIALISATION_SUPPORT */
        ...
        unittest_registrar    unittest_stlsoft_type_traits(test_stlsoft_type_traits);
    } // anonymous namespace
