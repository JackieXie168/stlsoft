...
#if !defined(STLSOFT_INCL_STLSOFT_HPP_CSTRING_MAKER)
# error This file cannot be directly included, and should only be included within stlsoft/cstring_maker.hpp
