...
#if !defined(STLSOFT_INCL_STLSOFT_HPP_STRING_TRAITS)
# error This file cannot be directly included, and should only be included within stlsoft/string_traits.hpp
