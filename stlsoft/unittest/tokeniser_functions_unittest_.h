...
#if !defined(STLSOFT_INCL_STLSOFT_HPP_TOKENISER_FUNCTIONS)
# error This file cannot be directly included, and should only be included within stlsoft/tokeniser_functions.hpp
...
# endif /* compiler */
        ...
        ss_bool_t test_stlsoft_tokeniser_functions(unittest_reporter *r)
        {
            ss_bool_t               bSuccess    =   true;

            unittest_initialiser    init(r, "STLSoft", "tokeniser_functions", __FILE__);
...
# endif /* 0 */
        ...
        unittest_registrar    unittest_stlsoft_tokeniser_functions(test_stlsoft_tokeniser_functions);
    } // anonymous namespace
