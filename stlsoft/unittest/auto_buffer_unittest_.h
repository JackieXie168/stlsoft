...
namespace unittest
{
    namespace
    {
        ...
        ss_bool_t test_stlsoft_auto_buffer_1(unittest_reporter *r)
        {
        ...
        ss_bool_t test_stlsoft_auto_buffer_2(unittest_reporter *r)
        {
        ...
        ss_bool_t test_stlsoft_auto_buffer_3(unittest_reporter *r)
        {
        ...
        ss_bool_t test_stlsoft_auto_buffer_4(unittest_reporter *r)
        {
            typedef auto_buffer<char, 10>   buffer_t;
        ...
        ss_bool_t test_stlsoft_auto_buffer(unittest_reporter *r)
        {
            ...
            if(!test_stlsoft_auto_buffer_1(r))
            {
                bSuccess    =   false;
            }
            if(!test_stlsoft_auto_buffer_2(r))
            {
                bSuccess    =   false;
            }
            if(!test_stlsoft_auto_buffer_3(r))
            {
                bSuccess    =   false;
            }
            if(!test_stlsoft_auto_buffer_4(r))
            {
                bSuccess    =   false;
            }
