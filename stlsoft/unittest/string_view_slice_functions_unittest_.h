...
#if !defined(STLSOFT_INCL_STLSOFT_HPP_STRING_VIEW_SLICE_FUNCTIONS)
# error This file cannot be directly included, and should only be included within stlsoft/string_view_slice_functions.hpp
...
namespace unittest
{
    namespace
    {
        ...
        ss_bool_t test_stlsoft_string_view_slice_functions(unittest_reporter *r)
        {
            ...
            unittest_initialiser    init(r, "STLSoft", "string_view_slice_functions", __FILE__);
