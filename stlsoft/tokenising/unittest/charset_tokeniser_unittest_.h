...
#if !defined(STLSOFT_INCL_STLSOFT_TOKENISING_HPP_CHARSET_TOKENISER)
# error This file cannot be directly included, and should only be included within stlsoft/tokenising/charset_tokeniser.hpp
...
namespace unittest
{
    ...
    namespace
    {
        ss_bool_t test_stlsoft_tokenising_charset_tokeniser_1(unittest_reporter *r)
        {
        ...
        ss_bool_t test_stlsoft_tokenising_charset_tokeniser_2(unittest_reporter *r)
        {
            ss_bool_t               bSuccess    =   true;
...
//::fprintf(stderr, "# tokens: %u\n", stlsoft_ns_qual_std(distance(tokens.begin(), tokens.end())));
        ...
        ss_bool_t test_stlsoft_tokenising_charset_tokeniser(unittest_reporter *r)
        {
            ss_bool_t               bSuccess    =   true;

            unittest_initialiser    init(r, "STLSoft", "tokenising/charset_tokeniser", __FILE__);

            if(!test_stlsoft_tokenising_charset_tokeniser_1(r))
            {
                bSuccess = false;
            }

            if(!test_stlsoft_tokenising_charset_tokeniser_2(r))
            {
                bSuccess = false;
            }
        ...
        unittest_registrar    unittest_stlsoft_tokenising_charset_tokeniser(test_stlsoft_tokenising_charset_tokeniser);
    } // anonymous namespace
