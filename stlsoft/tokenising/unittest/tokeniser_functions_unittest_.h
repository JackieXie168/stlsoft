...
# endif /* compiler */
        ...
        ss_bool_t test_stlsoft_tokenising_tokeniser_functions(unittest_reporter *r)
        {
            ss_bool_t               bSuccess    =   true;

            unittest_initialiser    init(r, "STLSoft", "tokenising/tokeniser_functions", __FILE__);
...
# endif /* 0 */
        ...
        unittest_registrar    unittest_stlsoft_tokenising_tokeniser_functions(test_stlsoft_tokenising_tokeniser_functions);
    } // anonymous namespace
