...
#if !defined(WINSTL_INCL_WINSTL_HPP_CLIPBOARD_SCOPE)
# error This file cannot be directly included, and should only be included within winstl/clipboard_scope.hpp
...
namespace unittest
{
    namespace
    {
        ss_bool_t test_winstl_clipboard_scope(unittest_reporter *r)
        {
            ...
            unittest_initialiser    init(r, "WinSTL", "clipboard_scope", __FILE__);
        ...
        unittest_registrar    unittest_winstl_clipboard_scope(test_winstl_clipboard_scope);
    } // anonymous namespace
