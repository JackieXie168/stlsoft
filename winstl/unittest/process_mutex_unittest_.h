...
#if !defined(WINSTL_INCL_WINSTL_HPP_PROCESS_MUTEX)
# error This file cannot be directly included, and should only be included within winstl/process_mutex.hpp
