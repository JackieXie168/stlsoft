...
#if !defined(WINSTL_INCL_WINSTL_HPP_PROCESSTIMES_COUNTER)
# error This file cannot be directly included, and should only be included within winstl/processtimes_counter.hpp
