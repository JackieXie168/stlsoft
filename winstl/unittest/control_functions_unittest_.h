...
#if !defined(WINSTL_INCL_WINSTL_H_CONTROL_FUNCTIONS)
# error This file cannot be directly included, and should only be included within winstl/control_functions.hpp
