...
#if !defined(WINSTL_INCL_WINSTL_H_COMMCTRL_FUNCTIONS)
# error This file cannot be directly included, and should only be included within winstl/commctrl_functions.hpp
