...
#if !defined(WINSTL_INCL_WINSTL_HPP_GLOBAL_ALLOCATOR)
# error This file cannot be directly included, and should only be included within winstl/global_allocator.hpp
