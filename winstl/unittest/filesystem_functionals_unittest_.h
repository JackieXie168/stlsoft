...
#if !defined(WINSTL_INCL_WINSTL_HPP_FILESYSTEM_FUNCTIONALS)
# error This file cannot be directly included, and should only be included within winstl/filesystem_functionals.hpp
...
namespace unittest
{
    namespace
    {
        ss_bool_t test_winstl_filesystem_functionals(unittest_reporter *r)
        {
            ...
            unittest_initialiser    init(r, "WinSTL", "filesystem_functionals", __FILE__);
