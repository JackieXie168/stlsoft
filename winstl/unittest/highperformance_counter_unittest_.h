...
#if !defined(WINSTL_INCL_WINSTL_HPP_HIGHPERFORMANCE_COUNTER)
# error This file cannot be directly included, and should only be included within winstl/highperformance_counter.hpp
