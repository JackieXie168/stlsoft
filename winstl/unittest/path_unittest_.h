...
#if !defined(WINSTL_INCL_WINSTL_HPP_PATH)
# error This file cannot be directly included, and should only be included within winstl/path.hpp
...
namespace unittest
{
    namespace
    {
        ss_bool_t test_winstl_path(unittest_reporter *r)
        {
            ...
            unittest_initialiser    init(r, "WinSTL", "path", __FILE__);
