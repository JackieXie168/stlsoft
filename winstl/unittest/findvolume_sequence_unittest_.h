...
#if !defined(WINSTL_INCL_WINSTL_HPP_FINDVOLUME_SEQUENCE)
# error This file cannot be directly included, and should only be included within winstl/findvolume_sequence.hpp
