...
#if !defined(WINSTL_INCL_WINSTL_HPP_MODULE_DIRECTORY)
# error This file cannot be directly included, and should only be included within winstl/module_directory.hpp
