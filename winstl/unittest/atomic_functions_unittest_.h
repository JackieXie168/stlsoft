...
#if !defined(WINSTL_INCL_WINSTL_H_ATOMIC_FUNCTIONS)
# error This file cannot be directly included, and should only be included within winstl/atomic_functions.hpp
