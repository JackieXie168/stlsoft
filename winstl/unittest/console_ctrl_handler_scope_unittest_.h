...
#if !defined(WINSTL_INCL_WINSTL_HPP_CONSOLE_CTRL_HANDLER_SCOPE)
# error This file cannot be directly included, and should only be included within winstl/console_ctrl_handler_scope.hpp
