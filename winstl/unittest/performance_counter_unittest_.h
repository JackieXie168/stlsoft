...
#if !defined(WINSTL_INCL_WINSTL_HPP_PERFORMANCE_COUNTER)
# error This file cannot be directly included, and should only be included within winstl/performance_counter.hpp
