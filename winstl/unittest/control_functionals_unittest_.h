...
#if !defined(WINSTL_INCL_WINSTL_HPP_CONTROL_FUNCTIONALS)
# error This file cannot be directly included, and should only be included within winstl/control_functionals.hpp
