...
#if !defined(WINSTL_INCL_WINSTL_HPP_THREADTIMES_COUNTER)
# error This file cannot be directly included, and should only be included within winstl/threadtimes_counter.hpp
