...
#if !defined(COMSTL_INCL_COMSTL_H_ERRORINFO_FUNCTIONS)
# error This file cannot be directly included, and should only be included within comstl/errorinfo_functions.h
