...
#if !defined(COMSTL_INCL_COMSTL_HPP_INTERFACE_PTR)
# error This file cannot be directly included, and should only be included within comstl/interface_ptr.hpp
