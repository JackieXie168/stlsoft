...
#if !defined(COMSTL_INCL_COMSTL_H_OLESTRING_FUNCTIONS)
# error This file cannot be directly included, and should only be included within comstl/olestring_functions.h
