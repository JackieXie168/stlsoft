...
#if !defined(COMSTL_INCL_COMSTL_H_REFCOUNT_FUNCTIONS)
# error This file cannot be directly included, and should only be included within comstl/refcount_functions.h
