...
#if !defined(MFCSTL_INCL_MFCSTL_HPP_RESOURCE_STRING)
# error This file cannot be directly included, and should only be included within mfcstl/resource_string.hpp
