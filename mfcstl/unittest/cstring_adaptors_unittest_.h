...
#if !defined(MFCSTL_INCL_MFCSTL_HPP_CSTRING_ADAPTORS)
# error This file cannot be directly included, and should only be included within mfcstl/cstring_adaptors.hpp
...
# pragma message("TODO: Fix this up before 1.9.1 proper")
        ...
        ss_bool_t test_mfcstl_cstring_adaptors(unittest_reporter *r)
        {
            ...
            unittest_initialiser    init(r, "MFCSTL", "cstring_adaptors", __FILE__);
