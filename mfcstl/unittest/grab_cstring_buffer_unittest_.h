...
#if !defined(MFCSTL_INCL_MFCSTL_HPP_GRAB_CSTRING_BUFFER)
# error This file cannot be directly included, and should only be included within mfcstl/grab_cstring_buffer.hpp
