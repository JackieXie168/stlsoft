...
#if !defined(UNIXSTL_INCL_UNIXSTL_HPP_FILE_PATH_BUFFER)
# error This file cannot be directly included, and should only be included within unixstl/file_path_buffer.hpp
