...
#if !defined(ATLSTL_INCL_ATLSTL_HPP_CCOMBSTR_VENEER)
# error This file cannot be directly included, and should only be included within atlstl/ccombstr_veneer.hpp
